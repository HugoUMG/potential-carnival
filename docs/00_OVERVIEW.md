...
| TTS | `edge-tts` (8 voces curadas US/UK/AU: 6 adultas + infantiles Ana ♀ y Roger ♂, las únicas voces de niño de la plataforma + velocidad de síntesis; las ~47 en inglés valen en el DSL; las conversaciones eligen voz por hablante con `male_voice`/`female_voice`) |
