...
| TTS | `edge-tts` (10 voces curadas US/UK/AU: adultas e infantiles ♀/♂ + velocidad de síntesis; las ~47 en inglés valen en el DSL; las conversaciones eligen voz por hablante con `male_voice`/`female_voice`) |
