...
## Al cerrar una tarea: actualiza la documentación
...
| Tocaste… | Actualiza |
|----------|-----------|
| `parser.py`: tipo, campo o validación | [`docs/07_DSL.md`](docs/07_DSL.md) + `_WORKSHEET_SYSTEM` (`ai.py`) + `GENERATION_PROMPT` (`generationPrompt.ts`) |
| Un endpoint (nuevo, borrado o con otro contrato) | [`docs/05_API.md`](docs/05_API.md) |
| Tabla, columna, índice o migración | [`docs/04_DATABASE.md`](docs/04_DATABASE.md) |
| Prompts o lógica de IA | [`docs/06_AI.md`](docs/06_AI.md) |
| Renderer o componente de actividad | [`docs/08_RENDERER.md`](docs/08_RENDERER.md) |
| Auth, roles o permisos | [`docs/09_SECURITY.md`](docs/09_SECURITY.md) |
| Variable de entorno o despliegue | [`docs/10_DEPLOYMENT.md`](docs/10_DEPLOYMENT.md) |
| Cerraste o abriste un pendiente | [`docs/13_ROADMAP.md`](docs/13_ROADMAP.md) |
| Descartaste una alternativa por un motivo que no se lee en el código | [`docs/15_DECISIONS.md`](docs/15_DECISIONS.md) |

Un término propio nuevo va a [`docs/14_GLOSSARY.md`](docs/14_GLOSSARY.md). Una regla dura nueva, a
[`docs/12_RULES.md`](docs/12_RULES.md). **La documentación se actualiza en el mismo cambio, no
"después".**
