...
def test_roger_lleva_tono_subido_para_sonar_a_nino():
    # Es el único niño del endpoint y suena a adulto joven: +35Hz compensa. Ana no lo necesita.
    assert _pitch_for("en-US-RogerNeural") == "+35Hz"
...
def test_tts_params_no_pasa_pitch_none():
    ...
    assert _tts_params("en-US-RogerNeural", "-15%") == {"rate": "-15%", "pitch": "+35Hz"}
